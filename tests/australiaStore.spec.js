...
test('Verify whether the case created in Me@Woolies with Benefits as Cateogry and Benefits/Offers as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Click Setup', async () => {
        homePage = await home.userLogin(testdata.auStoreLoginUser)
    });
    ...
    await test.step('Benefit form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.benefitsCategory);
...
test('Verify whether the case created in Me@Woolies with Career and Recruitment Cateogry and External Candidate as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Career and Recruitment form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.careerAndRecruitmentCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Development and Learning as Cateogry and Apprentices / Traineeships as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Development and Learning form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.developmentAndLearningCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Development and Learning as Cateogry and Learning Completion Uploads as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_AdvisoryPayroll, VD.priority_Low, VD.developmentandLearning_Cat, VD.developmentandLearning_Cat_LearningCompletionUploads_SubCat);
        await homePage.close();
    });
});
...
test('Verify whether the case created in Me@Woolies with WorkJam as Cateogry and Accessing WorkJam as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('WorkJam form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.workJamCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Proactive Services T&A as Cateogry and Access Issues as subcategory is getting assigned to Proactive Services queue', async ({ page }) => {
    ...
    await test.step('Proactive Services T&A form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.proactiveServicesTACategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with W360 T&A as Cateogry and Allowances as subcategory is getting assigned to W360 T&A queue', async ({ page }) => {
    ...
    await test.step('W360 T&A form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.w360TACategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Team View as Cateogry and Personal Details as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Team View form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.teamViewCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Mobility as Cateogry and Relocation Queries as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Mobility form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.mobilityCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with People Data Self-Service as Cateogry and Data Query as subcategory is getting assigned to HR Reporting queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('People Dashboard Queries form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.peopleDataSelfServiceCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.PeopleDataSelfService_cat_DataQuery_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
...
test('Verify whether the case created in Me@Woolies with People Data Self-Service as Cateogry and Functional Query as subcategory is getting assigned to HR Reporting queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('People Dashboard Queries form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.PeopleDataSelfService_cat_FunctionalQuery_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
...
test('Verify whether the case created in Me@Woolies with People Data Self-Service as Cateogry and User Access Query as subcategory is getting assigned to People Systems - AU Successfactors queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('People Dashboard Queries form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.PeopleDataSelfService_cat_UserAccessQuery_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Medium, VD.peopleDashboardQueries_Cat, VD.peopleDashboardQueries_Cat_PeopleDashboardsUserAccessQuery_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with People Data Self-Service as Cateogry and Technical Issue as subcategory is getting assigned to People Systems - AU Successfactors queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('People Dashboard Queries form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.PeopleDataSelfService_cat_TechnicalIssue_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.peopleDashboardQueries_Cat, VD.peopleDashboardQueries_Cat_PeopleDashboardsTechnicalIssue_SubCat);
        await homePage.close();
    });
});
...
//Remuneration
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Benchmarking and Evaluations as subcategory is getting assigned to Remuneration queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Remuneration form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.remunerationCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.remuneration_Cat_BenchmarkingandEvaluations_SubCat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_Remuneration, VD.priority_Low, VD.remuneration_Cat, VD.remuneration_Cat_BenchmarkingandEvaluations_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and LOO - Request as subcategory is getting assigned to Remuneration queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Remuneration form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.remuneration_Cat_LOORequest_SubCat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_Remuneration, VD.priority_Low, VD.remuneration_Cat, VD.remuneration_Cat_LOORequest_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Redundancy/Managed Exit as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Remuneration form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.remuneration_Cat_RedundancyManagedExit_SubCat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_Remuneration, VD.priority_Medium, VD.remuneration_Cat, VD.remuneration_Cat_RedundancyManagedExit_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Remuneration Support as subcategory is getting assigned to Remuneration queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Remuneration form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.remuneration_Cat_RemunerationSupport_SubCat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_Remuneration, VD.priority_Low, VD.remuneration_Cat, VD.remuneration_Cat_RemunerationSupport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Reward Cycle as subcategory is getting assigned to Advisoey Payroll queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Remuneration form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.remuneration_Cat_RewardCycle_SubCat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_AdvisoryPayroll, VD.priority_Medium, VD.remuneration_Cat, VD.remuneration_Cat_RewardCycle_SubCat);
        await homePage.close();
    });
});
...
test('Verify whether the case created in Me@Woolies with Casual Conversion as Cateogry and Process Queries as subcategory is getting assigned to Advisory Admin queue', async ({ page }) => {
    ...
    await test.step('Casual Conversion form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.casualConversionCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Average Hours Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Report Requests form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.reportRequestsCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        ...
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.fillTheTargetedDeliveryDate(testdata.targetedDeliveryDate)
        await woolies.clickOnRequestFrequency()
        await woolies.fillTheSpecifyReportingPeriod(testdata.specifyReportingPeriod)
        await woolies.fillTheReportDataRequest(testdata.dataRequest)
        await woolies.fillTheFieldsAreRequired(testdata.fieldsAreRequired)
        await woolies.fillTheEmployeePopulationIsTheData(testdata.dataReportRequired)
        await woolies.fillTheSpecificationsRequired(testdata.specificationsRequired)
        await woolies.clickOnOutputFile()
        await woolies.clickOnAudience()
        await woolies.clickOnNext();
        await woolies.fillThePhoneNumber(testdata.phoneNumber);
        await woolies.fillTheEmail(testdata.email);
        await woolies.clickOnSubmit();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_AdvisoryPayroll, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_AverageHoursReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Changes to Existing Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_ChangestoExistingReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and HR Report Access as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_HRReportAccess_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Learning Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_LearningReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Payroll Data - Employee Earnings Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_PayrollAUReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_PayrollDataEmployeeEarningsReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Payroll Data - Finance Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_PayrollAUReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_PayrollDataFinanceReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Payroll Data - Leave Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_PayrollDataLeaveReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Payroll Data - Superannuation Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_PayrollAUReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_PayrollDataSuperannuationReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and People Data report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_PeopleDatareport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Team Member Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_HRReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_TeamMemberReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and Wage Costing Report as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_PayrollAUReporting, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_WageCostingReport_SubCat);
        await homePage.close();
    });
});
test('Verify whether the case created in Me@Woolies with Report Requests as Cateogry and WFC – Store Team Member Punch / Clock as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_PeopleSystemsProductivity, VD.priority_Low, VD.reportRequests_Cat, VD.reportRequests_Cat_WFCStoreTeamMemberPunchClock_SubCat);
        await homePage.close();
    });
});
...
test('Verify whether the case created in Me@Woolies with Workplace Ajustment & Flexible Work Request as Cateogry and Health Related Matters as subcategory is getting assigned to ER Advisory queue', async ({ page }) => {
    ...
    await test.step('Workplace Adjustment Category form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.workplaceAdjustmentFlexibleWorkplaceRequestCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Workplace Ajustment & Flexible Work Request as Cateogry and Flexibility Agreement as subcategory is getting assigned to ER Advisory queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Workplace Adjustment Category form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.workplaceAdjustmentFlexibleWorkRequest_Cat_FlexibilityAgreement_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_ER, VD.caseOwner_ERAdvisory, VD.priority_Low, VD.employeeRelations_Cat, VD.workplaceAdjustmentFlexibleWorkRequest_Cat_FlexibilityAgreement_Subcat);
        await homePage.close();
    });
});
...
test('Verify whether the case created in Me@Woolies with Leaving the Company as Cateogry and Death in Service as subcategory is getting assigned to Payroll AU Service Delivery queue', async ({ page }) => {
    ...
    await test.step('leaving the Company form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.leavingtheCompanyCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Kronos as Cateogry and Kronos Planned Leave as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Kronos form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.kronosCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Team Data App as Cateogry and Team Data App as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Team Data App form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.teamDataAppCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Success Factors Technical Issue as Cateogry is getting assigned to Advisory Payroll queue', async ({ page }) => {
    ...
    await test.step('Success Factors Technical Issue form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.successFactorsTechnicalIssuesCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Pay and the Basics Cateogry and Adhoc (No Pay) as subcategory is getting assigned to Payroll AU Service Delivery queue', async ({ page }) => {
    ...
    await test.step('Pay and the Basics form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.payAndTheBasicsCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
...
test('Verify whether the case created in Me@Woolies with Pay and the Basics Cateogry and Purchase Leave as subcategory is getting assigned to Advisory Payroll queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Pay and the Basics form', async () => {
        ...
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.selectSubcatDropdown(CS.payandtheBasics_Cat_PurchaseLeave_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_AdvisoryPayroll, VD.priority_Low, VD.payandtheBasics_Cat, VD.payandtheBasics_Cat_PurchasLeave_Subcat);
        await homePage.close();
    });
});
...
//Prefered Name Email change
test('Verify whether the case created in Me@Woolies with Prefered Name Email change Cateogry and Personal Details as subcategory is getting assigned to Advisory Admin queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
    ...
    await test.step('Pay and the Basics form', async () => {
        await woolies.clickOnStorePeopleService();
        await woolies.selectCatagiores(testdata.preferredNameEmailChangeCategory);
        await woolies.clickonRaisingSomeone();
        await woolies.clickOnNewRequest();
        await woolies.fillTheExistingNumber(testdata.existingCaseNumber);
        await woolies.clickOnPreferredNameThroughSuccessFactors()
        await woolies.selectSubcatDropdown(CS.preferredNameEmailChange_Cat_PersonalDetails_Subcat);
        await woolies.fillTheName(testdata.firstName);
        await woolies.clickOnNext();
        await woolies.fillTheSubject(testdata.subject);
        await woolies.clickOnNext();
    ...
    await test.step('Verification of case details', async () => {
        ...
        await home2.enterTheCaseNumber(caseNumber);
        await home2.clickCaseNumber(caseNumber);
        await home2.verifyCaseDetails(VD.recordType_Query, VD.caseOwner_AdvisoryAdmin, VD.priority_Low, VD.preferredNameEmailChange_Cat, VD.preferredNameEmailChange_Cat_PersonalDetails_SubCat);
        await homePage.close();
    });
});
