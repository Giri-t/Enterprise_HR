...
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Redundancy/Managed Exit as subcategory is getting assigned to People Advisory queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
...
test('Verify whether the case created in Me@Woolies with Remuneration as Cateogry and Reward Cycle as subcategory is getting assigned to People Advisory queue', async ({ page }) => {
    let homePage, wooliesPage;
    let caseNumber;
    const login = new LoginPage(page);
    await test.step('Login Page', async () => {
